...
function NamiWalletApi(NamiWalletObject, protocolParameterObject, serializationLib) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        function send(_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var PaymentAddress, utxos, lovelace, ReceiveAddress, multiAsset, outputValue, minAda, outputs, RawTransaction;
        ...
        function sendMultiple(_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var PaymentAddress, utxos, outputs, _i, recipients_1, recipient, lovelace, ReceiveAddress, multiAsset, outputValue, minAda, RawTransaction;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0: return [4 /*yield*/, getAddress()];
                        case 1:
        ...
        var S, _a, Buffer, Nami, fetch, protocolParameter, CoinSelection;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = serializationLib;
                    if (_a) return [3 /*break*/, 2];
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('@emurgo/cardano-serialization-lib-asmjs'); })];
                case 1:
                    _a = (_b.sent());
                    _b.label = 2;
                case 2:
                    S = _a;
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('buffer'); })];
                case 3:
                ...
                case 4:
                    ...
                    protocolParameter = protocolParameterObject;
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./coinSelection'); })];
                case 5:
